...
On the RDK X5 platform, set ION memory size to 1.6GB. On the RDK S100 platform, set ION memory size to greater than 1.6GB; otherwise, model loading will fail.
