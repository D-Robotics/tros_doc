...
#### 配置音频板
    ...
    首次使用音频板需要使用`srpi-config`进行配置，配置方法参考RDK用户手册[RDK X5微雪Audio Drive](https://developer.d-robotics.cc/rdk_x_doc/Basic_Application/audio/rdk_x5/in_board_es8326?v=3.5.0&p=RDK+X5)章节。
