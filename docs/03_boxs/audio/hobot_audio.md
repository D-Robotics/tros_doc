...
#### 配置音频板
    ...
    首次使用音频板需要使用`srpi-config`进行配置，配置方法参考RDK用户手册[RDK X3微雪Audio Drive](https://liqinglian01.github.io/rdk_x_doc/Basic_Application/audio/rdk_x3_and_rdk_x3_module/audio_driver_hat2_rev2)章节。

    </DocScope>
    <DocScope products="RDK X5">

    首次使用音频板需要使用`srpi-config`进行配置，配置方法参考RDK用户手册[RDK X5微雪Audio Drive](https://liqinglian01.github.io/rdk_x_doc/Basic_Application/audio/rdk_x5/audio_driver_hat2_rev2)章节。
